...
public class FileUploadController {
    ...
    public R<Map<String, String>> upload(@RequestParam("file") MultipartFile file) {
        ...
        if (!ext.matches("\\.(png|jpg|jpeg|gif|webp|svg|bmp|ico)")) {
            throw new BizException("仅支持图片格式 (png/jpg/gif/webp/svg)");
        }
        ...
        try {
            ...
            // 对 jpg/png 自动压缩，gif/webp/svg 原样保留
    ...
    public R<Map<String, String>> uploadBase64(@RequestBody Map<String, String> body) {
